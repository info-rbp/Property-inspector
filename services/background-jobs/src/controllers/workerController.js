...
exports.cronStuckJobs = exports.runWorker = void 0;
const workerCore_1 = require("../worker/workerCore");
...
const runWorker = async (req, res) => {
    try {
        ...
        await (0, workerCore_1.processJob)(jobId, idempotencyKey);
...
const cronStuckJobs = async (req, res) => {
    try {
        const count = await jobService_1.jobService.reQueueStuckJobs();
...
exports.cronStuckJobs = cronStuckJobs;
