  ...
  <body>
    ...
    <script type="text/babel">
      ...
      const ROOM_TYPES = [
        ...
        'Hallway', 'Dining Room', 'Study', 'Entry'
      ];
      ...
      const App = () => {
        ...
        const handlePhotoUpload = async (roomId, files) => {
          ...
          if (newPhotos.length > 0) {
            analyzePhotosWithAI(roomId, newPhotos);
          }
        };
        
        const analyzePhotosWithAI = async (roomId, photos) => {
          setIsAnalyzing(true);
          try {
            for (const photo of photos) {
              ...
              const response = await fetch('/api/gemini/analyze', {
                ...
                body: JSON.stringify({
                  prompt: 'Analyze this property photo and identify the room type and any visible defects or notable features. Return a brief description.',
                  images: [{
                    data: base64.split(',')[1],
              ...
              if (response.ok) {
                ...
                // Update photo tags or room comments based on analysis
              }
            }
          } catch (error) {
          ...
          <div className="min-h-screen bg-gray-100">
            <div className="max-w-7xl mx-auto p-4">
              ...
              <div className="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <p className="text-gray-600">AI-Powered Property Condition Reporting</p>
              </div>
