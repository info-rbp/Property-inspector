...
import { ReportData, Room, ReportViewMode, InspectionItem, ReportType, ConditionRating, Property } from '@/types';
...
const ConditionReport: React.FC<ConditionReportProps> = ({ reportType }) => {
  ...
  const [viewMode, setViewMode] = useState<ReportViewMode>('edit');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={(e) => updateReport({ property: { ...report.property, address: e.target.value } })}
            ...
            <div>
              ...
              <input
                type="text"
                value={report.property.ownerName}
                onChange={(e) => updateReport({ property: { ...report.property, ownerName: e.target.value } })}
                className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
            ...
            <div>
              ...
              <input
                type="text"
                value={report.property.tenantName}
                onChange={(e) => updateReport({ property: { ...report.property, tenantName: e.target.value } })}
                className="w-full border border-gray-300 rounded-lg p-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
