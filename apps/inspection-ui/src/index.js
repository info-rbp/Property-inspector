                ...
                <div className="max-w-4xl mx-auto px-4 py-16">
                    <div className="bg-white rounded-lg shadow-lg p-12 text-center">
                        <div className="w-24 h-24 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            <i className="fas fa-hard-hat text-yellow-600 text-4xl"></i>
                        </div>
                        <h2 className="text-3xl font-bold text-gray-800 mb-4">
                            {feature} - Coming Soon!
                        </h2>
                        <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                            We're working hard to bring you this feature. It will be available shortly. 
                            In the meantime, feel free to explore our inspection report features.
                        </p>
                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 max-w-xl mx-auto">
                            ...
                            <ul className="text-left text-gray-600 space-y-2">
                                {feature === 'Properties' && (
                                    <>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Complete property portfolio management</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Owner and tenant information</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Key tracking and access management</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Property documents storage</li>
                                    </>
                                )}
                                {feature === 'Proposals' && (
                                    <>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Professional proposal templates</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Management agreement generation</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Fee structure calculator</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Digital signature integration</li>
                                    </>
                                )}
                                {feature === 'Feature Request' && (
                                    <>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Submit feature suggestions</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Vote on upcoming features</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Track development progress</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Direct feedback to development team</li>
                                    </>
                                )}
                                {feature === 'Settings' && (
                                    <>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Company branding customization</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>API key management</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>User preferences</li>
                                        <li><i className="fas fa-check text-green-500 mr-2"></i>Report templates configuration</li>
                                    </>
                                )}
                            </ul>
                        </div>
        ...
        const App = () => {
            ...
            const getActiveComponent = () => {
                switch (activeTool) {
                    ...
                    case 'properties':
                        return <UnderConstruction feature="Properties" />;
                    case 'proposals':
                        return <UnderConstruction feature="Proposals" />;
                    case 'feature-request':
                        return <UnderConstruction feature="Feature Request" />;
                    case 'settings':
                        return <UnderConstruction feature="Settings" />;
                    default:
                        return null;
                }
            };
                        ...
                        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="flex justify-between h-16 items-center">
                                ...
                                <nav className="hidden md:flex items-center gap-2">
                                    ...
                                    <NavButton tool="properties" icon="fas fa-building" label="Properties" />
                                    <NavButton tool="proposals" icon="fas fa-file-contract" label="Proposals" />
                                    <NavButton tool="feature-request" icon="fas fa-lightbulb" label="Feature Request" />
                            ...
                            <div className="max-w-7xl mx-auto px-4 py-10 animate-in">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                    ...
                                    <div 
                                        ...
                                        className="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg hover:border-purple-300 transition-all cursor-pointer"
                                    >
                                    ...
                                    <div 
                                        ...
                                        className="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg hover:border-indigo-300 transition-all cursor-pointer"
                                    >
                                        ...
                                        <div className="flex items-center text-indigo-600 text-sm font-semibold">
                                            Create Proposal <i className="fas fa-arrow-right ml-2"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div 
                                        ...
                                        className="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg hover:border-yellow-300 transition-all cursor-pointer"
                                    >
                                        ...
                                        <div className="flex items-center text-yellow-600 text-sm font-semibold">
                                            Request Feature <i className="fas fa-arrow-right ml-2"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div 
                                        ...
                                        className="bg-white rounded-xl shadow-md border border-gray-200 p-6 hover:shadow-lg hover:border-gray-400 transition-all cursor-pointer"
                                    >
                                        ...
                                        <div className="flex items-center text-gray-600 text-sm font-semibold">
                                            Manage Settings <i className="fas fa-arrow-right ml-2"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
app.get('/api/reports', async (c) => {
    try {
        ...
        const fullReports = await Promise.all(reports.map(async (meta) => {
